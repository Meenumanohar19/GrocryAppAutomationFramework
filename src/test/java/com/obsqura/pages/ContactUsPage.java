...
public class ContactUsPage  extends PageUtility{
	...
	public String submitFormData(Person person) throws InterruptedException {
		...
		String newAlert = GetElemenText(alertText);
		System.out.println(newAlert.split("Alert!")[1].trim());
		return newAlert.split("Alert!")[1].trim();
	}
}